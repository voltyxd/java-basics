...
public class Anime {
    ...
    // 2 - Cada atributo de classe é criad oe inicializado com valores default ou o que for passada
    ...
    static {
        System.out.println("Dentro do bloco de inicializaçã estaticoo 3");
    }
    {
